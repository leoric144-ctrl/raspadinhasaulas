...
<style>
 ...
 .prize-item img { max-width: 50%; max-height: 50%; object-fit: contain; }
...
@media (max-width: 480px) {
          ...
          <div class="scratch-card-container">
              ...
              <div class="scratch-card-overlay" id="purchase-overlay">
                  <?php if ($is_logged_in): ?>
                      ...
                      <p class="overlay-price-text">Comprar por R$ 50,00</p>
                      <button class="overlay-buy-button" id="buy-button-overlay">
                          <section><div class="buy-text"> Comprar </div><div class="price-container"><span class="currency">R$</span> 50,00</div></section>
                      </button>
                  <?php else: ?>
              ...
              <?php if ($is_logged_in): ?>
                  <button class="footer-btn footer-btn-buy" id="buy-button-footer">
                      <section>
                        ...
                        <span>Comprar</span>
                        <div class="price-container"><span class="currency">R$</span> 50,00</div>
                      </section>
                  </button>
  ...
  <?php
  require __DIR__ . '/premiosraspadinhamagica.php';
  ?>
</main>
